...
#container.container
  .page.tabbar.js_show
    .page__bd(style='height:100%;')
      .weui-cells__title
        span(style="padding-right:20px")  供货内容
   ...
   ,@touchend='clearLoop')
              ...
              .weui-cell
                ...
                label 产品根数:
                .weui-cell__bd
                 input.weui-input(type='text',placeholder='',v-model='item.productNums')
              .weui-cell.weui-cell_access(@click="selectProductContent(index)")
                .weui-cell__bd
                   p 供应内容 
                .weui-cell__ft {{item.productCentent}}
    ...
    methods:{
        commit(){
            ...
            if(!flag){
               ...
               this.$store.dispatch('updateQuotedProduct',item)
               this.$router.go(-1)
            }
        ...
        pickerSave(){
           if(!this.selected[0]){
               ...
               switch(this.pickerType){
                   ...
                   break;
                   case "content":
                     this.quotedList[this.index].productCentent="产品"
                   break;
               }
               this.isPicker =false
               return
           ...
           console.log(value)
            switch(key){
                ...
                break;
                case 'content':
                 this.quotedList[this.index].productCentent=value
                break;
            }
            this.isPicker = false;
        },
